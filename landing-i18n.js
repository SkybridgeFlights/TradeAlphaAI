(function () {
  const translations = {
    ar: {
      ...
      "why.eyebrow": "لماذا TradeAlpha", "why.title": "وضوح يليق بمنتج مالي جاد", "why.lead": "TradeAlpha AI يقدم عرضاً مركزاً ومهنياً، حيث تكون الرسالة واضحة: منطق منضبط، مخاطرة مفهومة، وشفافية تدعم القرار.", "why.card1.kicker": "الثقة", "why.card1.title": "تقديم مالي أكثر نضجاً", "why.card1.body": "رسالة مركزة تضع القيمة في الواجهة: تجربة احترافية، تقديم واضح، ومظهر يليق بمنتج تداول عالي الثقة.", "why.card2.kicker": "منطق النظام", "why.card2.title": "تصنيف أوضح للمنهجية", "why.card2.body": "النظام مبني حول تداول الذهب بمنهج واضح وسهل القراءة، ما يمنح المتداول فهماً أسرع لما يقدمه المنتج فعلاً.", "why.card3.kicker": "ضبط المخاطر", "why.card3.title": "المخاطر جزء من العرض", "why.card3.body": "السوق المستهدف وملف المخاطرة معروضان بوضوح، حتى يبقى القرار مبنياً على فهم عملي لا على وعود عامة.", "why.card4.kicker": "الشفافية", "why.card4.title": "أداء يمكن مراجعته", "why.card4.body": "إثبات الأداء متاح عبر مصدر خارجي موثوق، بما يحافظ على نظافة العرض ووضوحه.",
      "about.eyebrow": "من نحن", "about.title": "عن TradeAlpha AI", "about.lead": "TradeAlpha AI هو نظام تداول ذهبي مركز، مبني حول منطق يتبع الاتجاه مع تركيز واضح على الانضباط، ضبط المخاطر، والشفافية في متابعة الأداء.", "founder.kicker": "المؤسس", "founder.title": "Wajd", "founder.p1": "تم تطوير TradeAlpha AI بواسطة Wajd متداول يركز على سوق الذهب منذ عام 2017.", "founder.p2": "على مدار السنوات كان التركيز دائما على بناء نهج تداول منضبط يعتمد على قراءة الاتجاه وإدارة المخاطر بدلا من مطاردة الأرباح السريعة.", "founder.p3": "TradeAlpha AI هو نتيجة هذا النهج:\nنظام واضح بدون تعقيد وبدون وعود مبالغ فيها.", "founder.p4": "جميع النتائج يتم تتبعها بشكل علني عبر Myfxbook بحيث يمكن لأي شخص مراجعة الأداء الفعلي في أي وقت.", "founder.p5": "إذا كنت تبحث عن تجربة تداول أكثر هدوءا وانضباطا يمكنك البدء مباشرة عبر البوت أو متابعة الأداء قبل اتخاذ القرار.", "about.card1.kicker": "التركيز", "about.card1.title": "تركيز واضح على الذهب", "about.card1.body": "النظام موجه لسوق الذهب مع تقديم مختصر وواضح يساعد المتداول على فهم طبيعة المنتج بسرعة.", "about.card2.kicker": "المنهج", "about.card2.title": "منهج يتبع الاتجاه بانضباط", "about.card2.body": "المنطق التشغيلي يركز على الوضوح والانضباط، مع تقديم يعكس وعياً بالمخاطر أكثر من الاعتماد على الوعود التسويقية.", "about.card3.kicker": "الشفافية", "about.card3.title": "متابعة أداء شفافة", "about.card3.body": "الأداء يراجع من خلال رابط تحقق خارجي واضح، بما يمنح المتداول نقطة مرجعية مباشرة قبل الاشتراك.",
    ...
    en: {
      ...
      "why.eyebrow": "Why TradeAlpha", "why.title": "Clarity suited to a serious trading product", "why.lead": "TradeAlpha AI presents a controlled and professional offer built around disciplined logic, understood risk, and transparency that supports better decisions.", "why.card1.kicker": "Trust", "why.card1.title": "A more mature financial presentation", "why.card1.body": "The message stays focused on what matters: professional delivery, clear positioning, and a presentation aligned with a serious trading product.", "why.card2.kicker": "System Logic", "why.card2.title": "Clearer product logic", "why.card2.body": "The system is positioned around gold trading with a readable structure that helps visitors understand what the product actually does.", "why.card3.kicker": "Risk Control", "why.card3.title": "Risk is part of the presentation", "why.card3.body": "The target market and risk profile are shown plainly so the decision is based on operating context, not broad promises.", "why.card4.kicker": "Transparency", "why.card4.title": "Performance can be reviewed", "why.card4.body": "Performance is referenced through a trusted external source, keeping the presentation clean and verifiable.",
      "about.eyebrow": "About", "about.title": "Who We Are", "about.lead": "TradeAlpha AI is a focused gold trading system built around trend-following logic, disciplined execution, risk control, and transparent performance review.", "founder.kicker": "Founder", "founder.title": "Wajd", "founder.p1": "TradeAlpha AI was developed by Wajd, a trader focused on the gold market since 2017.", "founder.p2": "Over the years, the focus has been on building a disciplined trading approach based on trend reading and risk management, rather than chasing quick profits.", "founder.p3": "TradeAlpha AI reflects that philosophy:\na clear system, without unnecessary complexity or exaggerated claims.", "founder.p4": "All performance is tracked publicly via Myfxbook, allowing anyone to verify results transparently at any time.", "founder.p5": "If you're looking for a more structured and controlled trading experience, you can start directly via the bot, or monitor the performance before making a decision.", "about.card1.kicker": "Focus", "about.card1.title": "A clear focus on gold", "about.card1.body": "The system is built for the gold market and presented in a direct format that makes the product easy to understand.", "about.card2.kicker": "Logic", "about.card2.title": "Trend-following logic with discipline", "about.card2.body": "The operating approach favors clarity and control, with a tone grounded in risk awareness rather than exaggerated promises.", "about.card3.kicker": "Transparency", "about.card3.title": "Transparent performance review", "about.card3.body": "Performance is reviewed through a clear external verification path, giving traders a direct reference point before subscribing.",
    ...
    de: {
      ...
      "why.eyebrow": "Warum TradeAlpha", "why.title": "Klarheit für ein ernsthaftes Trading-Produkt", "why.lead": "TradeAlpha AI präsentiert ein kontrolliertes und professionelles Angebot, das auf disziplinierter Logik, nachvollziehbarem Risiko und Transparenz basiert.", "why.card1.kicker": "Vertrauen", "why.card1.title": "Ein reiferer finanzieller Auftritt", "why.card1.body": "Die Botschaft bleibt auf das Wesentliche fokussiert: professionelle Präsentation, klare Positionierung und ein Auftritt passend zu einem ernsthaften Trading-Produkt.", "why.card2.kicker": "Systemlogik", "why.card2.title": "Klarere Produktlogik", "why.card2.body": "Das System ist um Gold-Trading aufgebaut und so strukturiert, dass Besucher schnell verstehen, was das Produkt tatsächlich liefert.", "why.card3.kicker": "Risikokontrolle", "why.card3.title": "Risiko ist Teil der Darstellung", "why.card3.body": "Zielmarkt und Risikoprofil werden offen dargestellt, damit die Entscheidung auf operativem Kontext statt auf allgemeinen Versprechen basiert.", "why.card4.kicker": "Transparenz", "why.card4.title": "Performance ist überprüfbar", "why.card4.body": "Die Performance wird über eine vertrauenswürdige externe Quelle referenziert und bleibt dadurch sauber und nachvollziehbar.",
      "about.eyebrow": "Über uns", "about.title": "Wer wir sind", "about.lead": "TradeAlpha AI ist ein fokussiertes Gold-Trading-System, aufgebaut auf trendfolgender Logik, disziplinierter Ausführung, Risikokontrolle und transparenter Performance-Prüfung.", "founder.kicker": "Gründer", "founder.title": "Wajd", "founder.p1": "TradeAlpha AI wurde von Wajd entwickelt, einem Trader mit Fokus auf den Goldmarkt seit 2017.", "founder.p2": "Im Laufe der Jahre lag der Schwerpunkt darauf, einen disziplinierten Handelsansatz aufzubauen, der auf Trendanalyse und Risikomanagement basiert, anstatt schnellen Gewinnen nachzujagen.", "founder.p3": "TradeAlpha AI spiegelt genau diese Philosophie wider:\nein klares System, ohne unnötige Komplexität und ohne übertriebene Versprechen.", "founder.p4": "Alle Ergebnisse werden öffentlich über Myfxbook verfolgt, sodass jeder die tatsächliche Performance jederzeit transparent überprüfen kann.", "founder.p5": "Wenn du nach einem strukturierteren und kontrollierteren Trading-Ansatz suchst, kannst du direkt über den Bot starten oder zuerst die Performance beobachten, bevor du eine Entscheidung triffst.", "about.card1.kicker": "Fokus", "about.card1.title": "Klarer Fokus auf Gold", "about.card1.body": "Das System ist auf den Goldmarkt ausgerichtet und in einem direkten Format dargestellt, das das Produkt leicht verständlich macht.", "about.card2.kicker": "Logik", "about.card2.title": "Trendfolgende Logik mit Disziplin", "about.card2.body": "Der operative Ansatz setzt auf Klarheit und Kontrolle und bleibt im Ton risikobewusst statt überzogen werblich.", "about.card3.kicker": "Transparenz", "about.card3.title": "Transparente Performance-Prüfung", "about.card3.body": "Die Performance wird über einen klaren externen Verifikationsweg geprüft und gibt Tradern vor der Subscription einen direkten Referenzpunkt.",
  ...
  function getMeta(map) {
    const page = document.body.dataset.page;
    if (page === "performance") {
      return {
        title: map.meta.performanceTitle,
        description: map.meta.performanceDescription,
        url: map.meta.performanceUrl,
        type: map.meta.performanceOgType
      };
    }

    return {
      title: map.meta.homeTitle,
      description: map.meta.homeDescription,
      url: map.meta.homeUrl,
      type: map.meta.homeOgType
    };
  }
  ...
  function applyLandingLanguage(lang) {
    ...
    setMeta('meta[property="og:locale"]', map.meta.locale);
    setMeta('meta[property="og:title"]', meta.title);
    setMeta('meta[property="og:description"]', meta.description);
    setMeta('meta[property="og:url"]', meta.url);
    setMeta('meta[property="og:type"]', meta.type);
    setMeta('meta[property="og:image"]', map.meta.image);
    setMeta('meta[property="og:image:alt"]', map.meta.imageAlt);
    setMeta('meta[name="twitter:card"]', map.meta.twitterCard);
    setMeta('meta[name="twitter:title"]', meta.title);
    setMeta('meta[name="twitter:description"]', meta.description);
    setMeta('meta[name="twitter:image"]', map.meta.image);
    ...
    window.dispatchEvent(new CustomEvent("ta:languagechange", { detail: { lang: lang } }));
  }

  function syncLandingLanguage() {
    applyLandingLanguage(getLanguage());
  }
