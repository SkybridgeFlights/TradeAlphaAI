...
function main() {
  // Only ship the calculator itself here — the existing /tools/ hub landing
  ...
  let written = 0;
  const targets = [
    { path: path.join(ROOT, 'tools', 'compound-interest', 'index.html'),        content: compoundInterestPage(false) },
    { path: path.join(ROOT, 'ar', 'tools', 'compound-interest', 'index.html'),  content: compoundInterestPage(true) }
  ];
...
module.exports = { compoundInterestPage, toolsIndexPage };
